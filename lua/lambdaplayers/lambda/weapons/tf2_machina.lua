...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
    tf2_machina = {
        ...
        OnAttack = function( self, wepent, target )
            ...
            local targetPos = ( ( wepent.l_TF_IsCharging and headHitBox and ( fullCharge or LambdaRNG( 1, 3 ) != 1 ) ) and LAMBDA_TF2:GetBoneTransformation( target, headHitBox ) or target:WorldSpaceCenter() )
            wepent.l_TF_ChargeIsFull = false

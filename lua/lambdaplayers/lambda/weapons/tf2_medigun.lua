    ...
    tf2_medigun = {
        ...
        OnThink = function( self, wepent, isdead )            
            if !isdead and self.l_TF_Medigun_ChargeReleased then
                ...
                self.l_TF_InvulnerabilityColor = ( self.l_TF_Medigun_BeamColor == 2 and "blue" or "red" )
            end
            ...
            elseif !isdead and IsValid( healTarget ) then
                ...
                local uberMat = "lambdaplayers/models/ubercharge/ubercharge_" .. ( self.l_TF_Medigun_BeamColor == 2 and "blue" or "red" )
                if self.l_TF_Medigun_ChargeReleased then
                    healTarget.l_TF_InvulnerabilityTime = ( CurTime() + 1.0 )
                    healTarget.l_TF_InvulnerabilityColor = self.l_TF_InvulnerabilityColor
                else
                    local chargeRate = 2.5

...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
    tf2_libertylauncher = {
        model = "models/lambdaplayers/tf2/weapons/w_liberty_launcher.mdl",
        ...
        OnDeploy = function( self, wepent )
            ...
            wepent:SetWeaponAttribute( "Sound", ")weapons/rocket_ll_shoot.wav" )
            wepent:SetWeaponAttribute( "CritSound", ")weapons/rocket_ll_shoot_crit.wav" )
        ...
        OnAttack = function( self, wepent, target )
            ...
            targetPos = LAMBDA_TF2:CalculateEntityMovePosition( target, self:GetRangeTo( target ), 1540, Rand( 0.5, 1.1 ), targetPos )

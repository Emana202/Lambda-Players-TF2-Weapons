...
table.Merge( _LAMBDAPLAYERSWEAPONS, {
    tf2_libertylauncher = {
        model = "models/lambdaplayers/weapons/tf2/w_liberty_launcher.mdl",
        origin = "Team Fortress 2",
        prettyname = "Liberty Launcher",
        holdtype = "rpg",
        bonemerge = true,
        ...
        OnDeploy = function( self, wepent )
            ...
            wepent:SetWeaponAttribute( "Sound", "lambdaplayers/weapons/tf2/libertylauncher/rocket_ll_shoot.mp3" )

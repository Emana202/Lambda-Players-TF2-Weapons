table.Merge( _LAMBDAPLAYERSWEAPONS, {
    tf2_battalionbackup = {
        model = "models/lambdaplayers/tf2/items/battalionbuff_bugle.mdl",
        origin = "Team Fortress 2",
        prettyname = "Battalion's Backup",
        holdtype = "melee",
        bonemerge = true,
        ...
        isbuffpack = true,
        bufftype = 2,
        buffpackmdl = "models/lambdaplayers/tf2/items/battalionbuff_backpack.mdl",
        ...
        OnAttack = function( self, wepent )
            ...
            self:SimpleWeaponTimer( 0.22, function()
                wepent:EmitSound( "weapons/battalions_backup_" .. ( self.l_TF_TeamColor == 1 and "red" or "blue" ) .. ".wav", nil, nil, nil, CHAN_STATIC )
            end )
